...
<head>
<meta charset="UTF-8">
<title>SMS/USSD CS - Insert respondents</title>
...
<script>		
    ...
    $('#delete').on('click', function(e){				
		...
		window.location = "contacts1.php?id=<?php echo $surv_id;?>&pTableData=" + TableData ;
    ...
    $('#insert').on('click', function(e){				
		...
		window.location = "compile.php?id=<?php echo $surv_id;?>&pTableData=" + TableData ;
